...
type (
	UserCandidature struct {
		...
		MaxLevelMemory     int        `json:"max_level_memory"`
		MaxLevelLogic      int        `json:"max_level_logic"`
		OtherInformation   string     `json:"other_information"`
		Language           string     `json:"language"`
		MeetingDate        ftapi.Time `json:"meeting_date"`
		PiscineDate        string     `json:"piscine_date"`
